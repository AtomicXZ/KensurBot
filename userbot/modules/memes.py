...
INSULT_STRINGS = [
    ...
    "Everyone has the right to be stupid but you seem to be abusing the privilege.",
    "I'm sorry I hurt your feelings when I called you stupid. I thought you already knew that.",
    "You should try tasting cyanide.",
    "Your enzymes are meant to digest rat poison.",
    "You should try sleeping forever.",
    "Pick up a gun shoot it in the opposite direction.",
    "You could make a world record by jumping from a plane without parachute.",
    "Try bathing with Hydrochloric Acid instead of water.",
    "Try this: if you hold your breath underwater for an hour, you can then hold it forever.",
    "Go Green! Stop inhaling Oxygen.",
    "God was searching for you. You should leave to meet him.",
    "Always give your 100%. Now, go donate blood.",
    ...
    "Try playing catch and throw with RDX. Heard it's fun.",
    ...
    "Your opinion should be taken with a glass of water and peed out.",
    "I think 'DILDO' is the perfect insult for you. You'd be a dick but you ain't real enough.",
    "I'd agree with you but then we'd both be wrong.",
    "Your only chance of getting laid is if you climb up a chicken's butt and wait.",
]
